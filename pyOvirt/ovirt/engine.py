...
from ..nuts.danglies import *
from ..nuts import get_bits


@memdecay(decay=60)
def list_vms(manager='', filter='', max=20000):
    ...
    for m in managers:
        ...
        retval.update({ m: [ vm.name for vm in get_bits('vms', m, filter, max / len(managers)) ]})
